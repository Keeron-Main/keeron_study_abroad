                                ...
                                <div>
                                    ...
                                    <div className="mb-10 w-full overflow-hidden rounded-sm">
                                        <div className="relative aspect-97/60 w-full sm:aspect-97/44">
                                            <Image
                                                src="/images/StudyDestination/Australlia.webp"
                                                alt="image"
                                                fill
                                    ...
                                    <p className="text-body-color mb-8 text-base leading-relaxed font-medium sm:text-lg sm:leading-relaxed lg:text-base lg:leading-relaxed xl:text-lg xl:leading-relaxed">
                                        Australia is a premier destination for international students, offering world-class education, a diverse cultural experience, and a high quality of life. With over 40 universities and a wide range of vocational education and training (VET) providers, Australia provides numerous opportunities for students to pursue their academic and professional goals.
                                    </p>
                                    {/* <p className="text-body-color mb-10 text-base leading-relaxed font-medium sm:text-lg sm:leading-relaxed lg:text-base lg:leading-relaxed xl:text-lg xl:leading-relaxed">
                                    ...
                                    <p className="text-body-color mb-10 text-base leading-relaxed font-medium sm:text-lg sm:leading-relaxed lg:text-base lg:leading-relaxed xl:text-lg xl:leading-relaxed">
                                        Australia offers robust post-graduation work opportunities through the Temporary Graduate visa (subclass 485). Graduates can stay and work in Australia for up to three years, depending on their qualification and field of study. This visa allows international students to gain valuable work experience and potentially transition to permanent residency.
                                    </p>
                                    ...
                                    <p className="text-body-color mb-10 text-base leading-relaxed font-medium sm:text-lg sm:leading-relaxed lg:text-base lg:leading-relaxed xl:text-lg xl:leading-relaxed">
                                        Australia provides a variety of scholarships for international students, including:
                                    </p>
                                    ...
                                    <ul className="text-body-color mb-10 list-inside list-disc">
                                        ...
                                        <li className="text-body-color mb-2 text-base font-medium sm:text-lg lg:text-base xl:text-lg">
                                            University-specific scholarships: Many Australian universities offer merit-based scholarships to international students. For example, Macquarie University offers a $10,000 Early Acceptance Scholarship to Indian students pursuing undergraduate or postgraduate coursework degrees.
                                        </li>
