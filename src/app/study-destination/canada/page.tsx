                                ...
                                <div>
                                    ...
                                    <div className="mb-10 w-full overflow-hidden rounded-sm">
                                        <div className="relative aspect-97/60 w-full sm:aspect-97/44">
                                            <Image
                                                src="/images/StudyDestination/Canada.webp"
                                                alt="image"
                                                fill
                                    ...
                                    <p className="text-body-color mb-8 text-base leading-relaxed font-medium sm:text-lg sm:leading-relaxed lg:text-base lg:leading-relaxed xl:text-lg xl:leading-relaxed">
                                        Canada stands as a premier destination for international students, renowned for its world-class education system, multicultural environment, and high quality of life. With over 3,000 co-op programs available across Canadian universities, students have ample opportunities to integrate practical work experience into their academic journey.
                                    </p>
                                    {/* <p className="text-body-color mb-10 text-base leading-relaxed font-medium sm:text-lg sm:leading-relaxed lg:text-base lg:leading-relaxed xl:text-lg xl:leading-relaxed">
                                    ...
                                    <p className="text-body-color mb-10 text-base leading-relaxed font-medium sm:text-lg sm:leading-relaxed lg:text-base lg:leading-relaxed xl:text-lg xl:leading-relaxed">
                                        Canada offers robust post-graduation work opportunities through the Post-Graduation Work Permit (PGWP) program. Graduates from eligible institutions can work in Canada for up to three years, gaining valuable experience that can lead to permanent residency.
                                    </p>
