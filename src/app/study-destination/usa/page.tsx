...
export const metadata: Metadata = {
    title: "USA - Study Destination | Keeron",
    description: "USA - Study Destination | Keeron",
    // other metadata
};
                            ...
                            <div>
                                ...
                                <div>
                                    ...
                                    <p className="text-body-color mb-8 text-base leading-relaxed font-medium sm:text-lg sm:leading-relaxed lg:text-base lg:leading-relaxed xl:text-lg xl:leading-relaxed">
                                        The United States offers a vast array of programs, world-class research and teaching, and vibrant campus life from small liberal arts colleges to large research universities. A U.S. degree gives you access to cutting-edge labs, internship pipelines, and a global alumni network that can accelerate your career. EducationUSA’s network helps international students find the right fit and shows why nearly a million students choose the U.S. for higher education each year.
                                    </p>
                                    {/* <p className="text-body-color mb-10 text-base leading-relaxed font-medium sm:text-lg sm:leading-relaxed lg:text-base lg:leading-relaxed xl:text-lg xl:leading-relaxed">
                                    ...
                                    <p className="text-body-color mb-10 text-base leading-relaxed font-medium sm:text-lg sm:leading-relaxed lg:text-base lg:leading-relaxed xl:text-lg xl:leading-relaxed">
                                        Studying in the U.S. doesn’t just give you a degree — it opens doors to real-world experience. As an international student, you can take advantage of Optional Practical Training (OPT), which allows you to work in your field of study for up to 12 months after graduation (and up to 36 months for STEM programs). This means you can step directly into internships, graduate roles, and even employer-sponsored positions with leading companies.
                                        With thousands of global employers actively hiring international graduates in the U.S., your education becomes a launchpad for a long-term career. At Keeron, we don’t just focus on getting you admitted — we prepare you for what comes next: internships, co-ops, networking opportunities, and career coaching that give you a competitive edge in the global job market.
                                    ...
                                    <p className="text-body-color mb-10 text-base leading-relaxed font-medium sm:text-lg sm:leading-relaxed lg:text-base lg:leading-relaxed xl:text-lg xl:leading-relaxed">
                                        Financing a U.S. degree is possible through a mix of sources:
                                    </p>
                                    ...
                                    <ul className="text-body-color mb-10 list-inside list-disc">
                                        <li className="text-body-color mb-2 text-base font-medium sm:text-lg lg:text-base xl:text-lg">
                                            University scholarships and assistantships — many U.S. colleges offer merit or need-based aid, and graduate assistantships can cover tuition and pay a stipend.
                                        </li>
                                        <li className="text-body-color mb-2 text-base font-medium sm:text-lg lg:text-base xl:text-lg">
                                            National & bilateral programs — e.g., the Fulbright Foreign Student Program funds thousands of international graduate students each year.
                                        </li>
                                        <li className="text-body-color mb-2 text-base font-medium sm:text-lg lg:text-base xl:text-lg">
                                            External scholarships & loans — private scholarships, country-based funds, and education loans tailored for international study.
                                        </li>
                                        <li className="text-body-color mb-2 text-base font-medium sm:text-lg lg:text-base xl:text-lg">
                                            Keeron helps you identify scholarship matches, prepare competitive scholarship applications, and build a realistic funding plan.
                                        </li>
                                    </ul>
                                    ...
                                    <ul className="text-body-color mb-10 list-inside list-disc">
                                        ...
                                        <li className="text-body-color mb-2 text-base font-medium sm:text-lg lg:text-base xl:text-lg">
                                            Accessible campus services (health, counseling, career centers), and
                                        </li>
                                        <li className="text-body-color mb-2 text-base font-medium sm:text-lg lg:text-base xl:text-lg">
                                            Plentiful part-time work/internship opportunities on and off campus.
                                        </li>
                                    </ul>
                                    <p className="text-body-color mb-10 text-base leading-relaxed font-medium sm:text-lg sm:leading-relaxed lg:text-base lg:leading-relaxed xl:text-lg xl:leading-relaxed">
                                        Typical monthly living costs vary widely by location; a single student’s pre-rent living expenses can range greatly depending on the city (Numbeo provides up-to-date local estimates). Keeron will help you plan realistic budgets and choose locations that fit your lifestyle and finances.
                                    </p>
