                                ...
                                <div>
                                    ...
                                    <div className="mb-10 w-full overflow-hidden rounded-sm">
                                        <div className="relative aspect-97/60 w-full sm:aspect-97/44">
                                            <Image
                                                src="/images/StudyDestination/Germany.webp"
                                                alt="image"
                                                fill
                                    ...
                                    <p className="text-body-color mb-10 text-base leading-relaxed font-medium sm:text-lg sm:leading-relaxed lg:text-base lg:leading-relaxed xl:text-lg xl:leading-relaxed">
                                        Germany offers a plethora of scholarships to support international students:
                                    </p>
                                    ...
                                    <ul className="text-body-color mb-10 list-inside list-disc">
                                        <li className="text-body-color mb-2 text-base font-medium sm:text-lg lg:text-base xl:text-lg">
                                            DAAD Scholarships: The German Academic Exchange Service provides numerous scholarships for international students at various degree levels.
                                        </li>
                                        <li className="text-body-color mb-2 text-base font-medium sm:text-lg lg:text-base xl:text-lg">
                                            Heinrich Böll Foundation Scholarships: These scholarships are awarded to international students pursuing higher education in Germany.
                                        </li>
                                        <li className="text-body-color mb-2 text-base font-medium sm:text-lg lg:text-base xl:text-lg">
                                            Erasmus+ Program: Funded by the European Union, this program offers grants for students from partner countries to study in Germany.
                                        </li>

                                    </ul>
                                    <p className="text-body-color mb-10 text-base leading-relaxed font-medium sm:text-lg sm:leading-relaxed lg:text-base lg:leading-relaxed xl:text-lg xl:leading-relaxed">
                                        Additionally, many universities in Germany offer merit-based scholarships to attract talented international students.
                                    </p>
                                    ...
                                    <p className="text-body-color mb-10 text-base leading-relaxed font-medium sm:text-lg sm:leading-relaxed lg:text-base lg:leading-relaxed xl:text-lg xl:leading-relaxed">
                                        Germany offers a high standard of living with a balanced lifestyle. The average monthly living expenses for students range between €850 and €1,500, depending on the city and personal lifestyle. Major cities like Munich, Frankfurt, and Berlin offer vibrant student life, with numerous cultural events, restaurants, and recreational activities. Public transportation is efficient and affordable, making it easy to explore the country.
                                    </p>
