                                ...
                                <div>
                                    ...
                                    <div className="mb-10 w-full overflow-hidden rounded-sm">
                                        <div className="relative aspect-97/60 w-full sm:aspect-97/44">
                                            <Image
                                                src="/images/StudyDestination/France_.webp"
                                                alt="image"
                                                fill
                                    ...
                                    <p className="text-body-color mb-10 text-base leading-relaxed font-medium sm:text-lg sm:leading-relaxed lg:text-base lg:leading-relaxed xl:text-lg xl:leading-relaxed">
                                        France offers a variety of scholarships to support international students:
                                    </p>
                                    ...
                                    <ul className="text-body-color mb-10 list-inside list-disc">
                                        <li className="text-body-color mb-2 text-base font-medium sm:text-lg lg:text-base xl:text-lg">
                                            Eiffel Excellence Scholarship: A prestigious scholarship program aimed at attracting top international students to French higher education institutions.
                                        </li>
                                        <li className="text-body-color mb-2 text-base font-medium sm:text-lg lg:text-base xl:text-lg">
                                            Campus France Scholarships: A platform providing information on various scholarships available to international students in France.
                                        </li>
                                        <li className="text-body-color mb-2 text-base font-medium sm:text-lg lg:text-base xl:text-lg">
                                            University-specific Scholarships: Many French universities offer merit-based scholarships to international students. For example, Sciences Po offers the Émile Boutmy Scholarship, awarded based on merit and social criteria.
                                        </li>
                                    ...
                                    <p className="text-body-color mb-10 text-base leading-relaxed font-medium sm:text-lg sm:leading-relaxed lg:text-base lg:leading-relaxed xl:text-lg xl:leading-relaxed">
                                        The cost of living in France varies depending on the city and lifestyle. On average, international students can expect to spend between €800 and €1,200 per month, covering accommodation, food, transportation, and leisure activities.
                                        France offers a high quality of life, with excellent public transportation, healthcare, and a rich cultural scene. Cities like Paris, Lyon, and Toulouse offer a vibrant student life, with numerous cultural events, festivals, and opportunities for travel within Europe.
