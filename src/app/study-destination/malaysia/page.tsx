                        ...
                        <div className="w-full px-4 lg:w-8/12">
                            <div>
                                ...
                                <div>
                                    ...
                                    <p className="text-body-color mb-10 text-base leading-relaxed font-medium sm:text-lg sm:leading-relaxed lg:text-base lg:leading-relaxed xl:text-lg xl:leading-relaxed">
                                        Malaysia offers a variety of scholarships for international students to support their studies. Notable scholarships include:
                                    </p>
                                    ...
                                    <ul className="text-body-color mb-10 list-inside list-disc">
                                        <li className="text-body-color mb-2 text-base font-medium sm:text-lg lg:text-base xl:text-lg">
                                            Malaysia International Scholarship (MIS): Aimed at attracting top talent from around the world to pursue postgraduate studies in Malaysia.
                                        </li>
                                        <li className="text-body-color mb-2 text-base font-medium sm:text-lg lg:text-base xl:text-lg">
                                            MTCP Scholarship: Offered to students from Malaysia Technical Cooperation Programme (MTCP) recipient countries for postgraduate studies.
                                        </li>
                                        <li className="text-body-color mb-2 text-base font-medium sm:text-lg lg:text-base xl:text-lg">
                                            University-specific scholarships: Many Malaysian universities offer merit-based scholarships to international students. For example, the University of Malaya offers scholarships to international students based on academic excellence.
                                        </li>
